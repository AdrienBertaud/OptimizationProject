...
from utils.figure import plot_sharpness_vs_batch_size, plot_sharpness_limit, plot_nonuniformity_limit, plot_sharpness_nonuniformity_fixed_batch_size, plot_sharpness_nonuniformity_fixed_lr, plot_sharpness_vs_learning_rate, plot_sharpness_vs_lr
...
def main():
    ...
    plot_sharpness_vs_learning_rate(results_data_frame, 'sgd')
