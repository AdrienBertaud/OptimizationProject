...
def plot_vs_learning_rate(df, batch_size = 'all', eval_algo='sharpness'):
    ...
    plt.savefig((SAVE_DIRECTORY + '/' 'sharpness vs learning rate.png'))
    plt.legend()
...
def plot_vs_batch_size(df, eval_algo='sharpness', optim_1 = 'adagrad', optim_2 = ''):
    ...
    plt.savefig((SAVE_DIRECTORY + '/' + fig_name + '.png'))
    plt.title(fig_name)
    plt.show()
...
def main():
    ...
    eval_algo_list = ['sharpness train','non uniformity train', 'duration']
