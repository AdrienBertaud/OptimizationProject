...
parser.add_argument('--max_iter', '-maxiter', default=defaultNumOfIter, help='max iterations')
...
# Softmax loss
# TODO: softmax_cross_entropy_with_logits (from tensorflow.python.ops.nn_ops) is deprecated and will be removed in a future version.
