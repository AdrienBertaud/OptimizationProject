...
def get_args():
    ...
    argparser.add_argument('--optimizer',
                            default='lbfgs', help='optimizer, [sgd]')
    ...
    argparser.add_argument('--model_file',
                            default='lbfgs.pkl', help='filename to save the net, fnn.pkl')
...
def main():
    ...
    train(net, criterion, optimizer, args.optimizer, train_loader, args.batch_size, args.n_iters, verbose=True)
